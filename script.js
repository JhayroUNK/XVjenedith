...
function revealExperience(){
  ...
  if(window.gsap){ gsap.to('.welcome-card',{opacity:0,y:-20,scale:.96,duration:.45,ease:'power2.in'}); gsap.to(welcome,{opacity:0,duration:.7,delay:.28,onComplete:()=>welcome.remove()}); gsap.from('.hero-content > *',{opacity:0,y:18,stagger:.1,duration:.8,delay:.25,ease:'power3.out'}); }
  else welcome.remove();
...
const eventDate = new Date('2026-10-17T19:00:00-05:00');
